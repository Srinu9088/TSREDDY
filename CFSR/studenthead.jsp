...
<body>
    ...
    <div id="sHead">
       ...
       <li><a href="Studentimages.jsp"><b>IMAGES</b></a></li>
        <li><a href="student.jsp"><b>STUDENT ENROLL</b></a></li> 
        <!--<li><a href="studentsearch.jsp"><b>SEARCH</b></a></li>--> 
        </ul>
                
        <form class="navbar-form navbar-left" action="ActivityChecking(student).jsp" style="padding-left: 450pt" method="post">
