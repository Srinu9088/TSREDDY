...
<style>
    ...
    function Print(){
        document.getElementById("sHead").style.visibility='hidden';
        ...
        $('#sData').css({"position":"absolute","top":"0px"});
        window.print();
         $('#sData').css({"position":"relative"});
        document.getElementById("sHead").style.visibility='visible';
...
<%@include file="studenthead.jsp"%> 
        ...
        <div id="tab">
         <form method="post">
    	 <table class="search_tab" style="margin-top: 30pt">
             <tr>
      ...
      if(!rs.next())
         ...
         %><center>
           ...
           <h3 style="color: red">No Records Found?<br><br>Search For Another....</h3>
             ...
             %>       
       <div class="col-sm-2" id="print1">
        <button class="btn btn-primary" onclick="Print()" style="border-radius: 5pt;margin: 10pt 0pt 0pt -10pt">PDF</button>
      </div>
      
        <div class="col-sm-1" id="print2">
