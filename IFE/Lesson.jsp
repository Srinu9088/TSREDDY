  ...
  <a href="Lesson.jsp">Lesson Planner</a>
    ...
    <%
       try
        ...
        String query = "select *from TBL_CONTENT";
        ResultSet rs=stmt.executeQuery(query);
       
            while(rs.next())
            {
                Date dat1=rs.getDate(3);
                DateFormat df=new SimpleDateFormat("dd-MM-yyyy");
                String sda=df.format(dat1);
                
                %>
<div class="main container-fluid">
        <div class="col-sm-4" style="background-color: aquamarine;" align=center>Date<br><% out.print(sda); %></div>
        <div class="col-sm-6" style="background-color: lightgreen" align=center>Notes<br><% out.print(rs.getString(4)); %></div>
